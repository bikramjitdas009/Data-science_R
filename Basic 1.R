...
#  where you can find the R source code, R manuals and documentation, and contributed packages
...
Data structure :  1.Vector - 1dimention,Homogenious
                  2.Matrix - 2dim,Homogenious (Same way,can be distributed uniformely)
                  3.Array - multi dim ,Homogenious
                  4.List - Multi dimention , Hetrogenious(Non-Uniform,different)
...
print(result) # 3*3 matrices 3 rows and 3 columns
...
!x # using exclamation mark

x&y # Ampersand or and symbol

x&&y
 
x|y # pipe, or Vertical bar
